...
mattercodex_set_defaults() {
  ...
  export MATTERCODEX_KANIKO_CPU_REQUEST="${MATTERCODEX_KANIKO_CPU_REQUEST:-1000m}"
  export MATTERCODEX_KANIKO_CPU_LIMIT="${MATTERCODEX_KANIKO_CPU_LIMIT:-8000m}"
  export MATTERCODEX_KANIKO_MEMORY_REQUEST="${MATTERCODEX_KANIKO_MEMORY_REQUEST:-2Gi}"
  export MATTERCODEX_KANIKO_MEMORY_LIMIT="${MATTERCODEX_KANIKO_MEMORY_LIMIT:-12Gi}"
  ...
  export MATTERCODEX_RUNTIME_QUOTA_REQUESTS_CPU="${MATTERCODEX_RUNTIME_QUOTA_REQUESTS_CPU:-32}"
  export MATTERCODEX_RUNTIME_QUOTA_REQUESTS_MEMORY="${MATTERCODEX_RUNTIME_QUOTA_REQUESTS_MEMORY:-128Gi}"
  export MATTERCODEX_RUNTIME_QUOTA_LIMITS_CPU="${MATTERCODEX_RUNTIME_QUOTA_LIMITS_CPU:-128}"
  export MATTERCODEX_RUNTIME_QUOTA_LIMITS_MEMORY="${MATTERCODEX_RUNTIME_QUOTA_LIMITS_MEMORY:-256Gi}"
