...
mattercodex_set_defaults() {
  ...
  export MATTERCODEX_KANIKO_CPU_LIMIT="${MATTERCODEX_KANIKO_CPU_LIMIT:-16000m}"
  export MATTERCODEX_KANIKO_MEMORY_REQUEST="${MATTERCODEX_KANIKO_MEMORY_REQUEST:-4Gi}"
  export MATTERCODEX_KANIKO_MEMORY_LIMIT="${MATTERCODEX_KANIKO_MEMORY_LIMIT:-32Gi}"
  ...
  export MATTERCODEX_RUNTIME_QUOTA_REQUESTS_CPU="${MATTERCODEX_RUNTIME_QUOTA_REQUESTS_CPU:-24}"
  export MATTERCODEX_RUNTIME_QUOTA_REQUESTS_MEMORY="${MATTERCODEX_RUNTIME_QUOTA_REQUESTS_MEMORY:-80Gi}"
  export MATTERCODEX_RUNTIME_QUOTA_LIMITS_CPU="${MATTERCODEX_RUNTIME_QUOTA_LIMITS_CPU:-32}"
  export MATTERCODEX_RUNTIME_QUOTA_LIMITS_MEMORY="${MATTERCODEX_RUNTIME_QUOTA_LIMITS_MEMORY:-96Gi}"
  export MATTERCODEX_RUNTIME_LIMIT_DEFAULT_CPU="${MATTERCODEX_RUNTIME_LIMIT_DEFAULT_CPU:-4000m}"
  export MATTERCODEX_RUNTIME_LIMIT_DEFAULT_MEMORY="${MATTERCODEX_RUNTIME_LIMIT_DEFAULT_MEMORY:-4Gi}"
