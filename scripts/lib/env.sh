...
mattercodex_set_defaults() {
  ...
  export MATTERCODEX_MATTERMOST_OAUTH2_PROXY_SOURCE_NAMESPACE="${MATTERCODEX_MATTERMOST_OAUTH2_PROXY_SOURCE_NAMESPACE:-kodex-prod}"
  export MATTERCODEX_MATTERMOST_OAUTH2_PROXY_SOURCE_SECRET="${MATTERCODEX_MATTERMOST_OAUTH2_PROXY_SOURCE_SECRET:-kodex-web-oauth2-proxy}"
  ...
  export MATTERCODEX_CODEX_PACKAGE="${MATTERCODEX_CODEX_PACKAGE:-@openai/codex@0.138.0}"
