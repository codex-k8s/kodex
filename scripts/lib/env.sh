...
mattercodex_set_defaults() {
  ...
  export MATTERCODEX_AGENT_RUNNER_IMAGE="${MATTERCODEX_AGENT_RUNNER_IMAGE:-node:22-alpine}"
  ...
  export MATTERCODEX_OPENAI_SECRET="${MATTERCODEX_OPENAI_SECRET:-matter-codex-openai}"
