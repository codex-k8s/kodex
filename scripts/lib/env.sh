...
mattercodex_set_defaults() {
  ...
  export MATTERCODEX_KANIKO_MEMORY_REQUEST="${MATTERCODEX_KANIKO_MEMORY_REQUEST:-1Gi}"
  export MATTERCODEX_KANIKO_MEMORY_LIMIT="${MATTERCODEX_KANIKO_MEMORY_LIMIT:-4Gi}"
