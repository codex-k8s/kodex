...
mattercodex_set_defaults() {
  ...
  export MATTERCODEX_ARTIFACTS_ENABLED="${MATTERCODEX_ARTIFACTS_ENABLED:-false}"
  export MATTERCODEX_ARTIFACT_S3_ENDPOINT="${MATTERCODEX_ARTIFACT_S3_ENDPOINT:-}"
  export MATTERCODEX_ARTIFACT_S3_REGION="${MATTERCODEX_ARTIFACT_S3_REGION:-us-east-1}"
  export MATTERCODEX_ARTIFACT_S3_BUCKET="${MATTERCODEX_ARTIFACT_S3_BUCKET:-}"
  export MATTERCODEX_ARTIFACT_S3_USE_PATH_STYLE="${MATTERCODEX_ARTIFACT_S3_USE_PATH_STYLE:-true}"
  export MATTERCODEX_ARTIFACT_MAX_FILES_PER_TURN="${MATTERCODEX_ARTIFACT_MAX_FILES_PER_TURN:-8}"
  export MATTERCODEX_ARTIFACT_MAX_OBJECT_BYTES="${MATTERCODEX_ARTIFACT_MAX_OBJECT_BYTES:-8388608}"
  export MATTERCODEX_ARTIFACT_MAX_TURN_BYTES="${MATTERCODEX_ARTIFACT_MAX_TURN_BYTES:-33554432}"
  export MATTERCODEX_ARTIFACT_RETENTION="${MATTERCODEX_ARTIFACT_RETENTION:-2160h}"
  export MATTERCODEX_ARTIFACT_STORAGE_SECRET="${MATTERCODEX_ARTIFACT_STORAGE_SECRET:-matter-codex-artifact-storage}"
