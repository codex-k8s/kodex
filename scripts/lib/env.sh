...
mattercodex_set_defaults() {
  ...
  export MATTERCODEX_BOT_SERVICE_CPU_LIMIT="${MATTERCODEX_BOT_SERVICE_CPU_LIMIT:-1}"
  export MATTERCODEX_BOT_SERVICE_MEMORY_LIMIT="${MATTERCODEX_BOT_SERVICE_MEMORY_LIMIT:-4Gi}"
  ...
  export MATTERCODEX_RUNTIME_QUOTA_LIMITS_CPU="${MATTERCODEX_RUNTIME_QUOTA_LIMITS_CPU:-128}"
