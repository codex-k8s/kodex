...
kodex_smoke_init "smoke-access-manager"
...
kodex_smoke_require_images \
  "KODEX_PLATFORM_EVENT_LOG_MIGRATIONS_IMAGE, KODEX_ACCESS_MANAGER_MIGRATIONS_IMAGE, KODEX_ACCESS_MANAGER_IMAGE" \
...
kodex_smoke_check_readyz access-manager 18080
