...
SERVICES="${KODEX_BACKEND_SMOKE_SERVICES:-access-manager project-catalog package-hub provider-hub fleet-manager runtime-manager agent-manager codex-hook-ingress integration-gateway}"
