...
log "  run scripts/smoke-package-hub.sh with KODEX_SMOKE_ENV_FILE=${BOOTSTRAP_ENV_FILE}"
log "  run scripts/smoke-integration-gateway.sh with KODEX_SMOKE_ENV_FILE=${BOOTSTRAP_ENV_FILE} after provider-hub images are loaded"
