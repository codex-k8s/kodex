...
func loadConfig() (Config, error) {
	config := Config{
		...
		OIDCIssuer: "https://sso.kodex.works/realms/mattercodex", OIDCAudience: "mattercodex-control-api", OIDCJWKSURL: "https://sso.kodex.works/realms/mattercodex/protocol/openid-connect/certs", OIDCConnectAddress: "sso.identity.svc.cluster.local:443", OIDCTLSServerName: "sso.kodex.works", OIDCCAFile: "/var/run/config/mattercodex/control-api-gateway/oidc/ca.pem", AllowedOrigins: "https://control.kodex.works",
