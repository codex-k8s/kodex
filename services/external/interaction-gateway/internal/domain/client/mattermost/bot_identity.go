...
type BotIdentityClient interface {
	...
	CreateBotAccessToken(context.Context, entity.AgentMattermostBotIdentity, string) (string, string, error)
	ResolveBotAccessToken(context.Context, entity.AgentMattermostBotIdentity, string) (string, bool, error)
	RecoverBotAccessToken(context.Context, entity.AgentMattermostBotIdentity, string) (string, bool, error)
	RevokeBotAccessToken(context.Context, entity.AgentMattermostBotIdentity) (bool, error)
