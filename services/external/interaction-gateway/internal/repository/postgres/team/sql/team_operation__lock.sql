...
SELECT operation_id::text, organization_id::text, project_id::text, actor_id::text,
       ...
       provider_snapshot_sha256, provider_causality_sha256, provider_receipt_sha256, COALESCE(provider_generation, 0),
       failure_code, fence, COALESCE(effect_started_at, 'epoch'::timestamptz),
       retry_not_before, recovery_deadline, created_at, updated_at,
