...
SELECT metadata.schema_version,
       ...
       AND EXISTS (
           ...
           WHERE namespace.nspname = 'public'
             AND relation.relname = 'interaction_gateway_team_catalog_cursors'
       ...
       AND EXISTS (
           ...
           WHERE schemaname = 'public'
             AND tablename = 'interaction_gateway_team_catalog_cursors'
             AND policyname = 'interaction_gateway_team_cursor_runtime_scope'
