SELECT id, kind, state, organization_id, project_id, session_id, turn_id,
       ...
       attachments, provider_post_id, provider_receipt_sha256, update_post_id,
       attempts, ack_attempts, fence, lease_expires_at, next_attempt_at,
       last_error_code, owner_gate_id, COALESCE(owner_gate_version, 0),
