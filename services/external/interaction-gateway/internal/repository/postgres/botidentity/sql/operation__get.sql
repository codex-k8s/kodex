...
WHERE operation.organization_id = @arg1::uuid AND operation.project_id = @arg2::uuid
  AND operation.actor_id = @arg3::uuid AND operation.agent_ref = @arg4::uuid
  AND operation.action = @arg5::text AND operation.idempotency_key = @arg6::uuid;
