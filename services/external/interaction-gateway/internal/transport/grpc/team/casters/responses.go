...
func safeFailureCode(code string) string {
	...
	case "", "OWNER_OUTCOME_UNKNOWN", "OWNER_STATE_CONFLICT", "OWNER_READBACK_MISMATCH",
		...
		"WORKSPACE_MAPPING_PRINCIPAL_BINDING_REJECTED", "WORKSPACE_MAPPING_PROVIDER_RECEIPT_REJECTED",
		"WORKSPACE_MAPPING_COMMAND_INTENT_REJECTED", "WORKSPACE_MAPPING_TARGET_BINDING_REJECTED":
		return code
	default:
		return "SAFE_FAILURE"
	}
