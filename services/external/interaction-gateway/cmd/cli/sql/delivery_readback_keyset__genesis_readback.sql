SELECT fence.keyset_revision,
  ...
  FROM interaction_gateway_delivery_readback_keyset_fence AS fence
 CROSS JOIN interaction_gateway_delivery_readback_key_history AS history
 WHERE EXISTS (
       SELECT 1 FROM interaction_gateway_delivery_readback_keyset_audit WHERE action = 'GENESIS'
 )
