...
select
	...
	a.id, version.id, a.project_id, a.chat_id, a.session_id, delivery.turn_id, a.direction,
...
where delivery.project_id = $1 and delivery.chat_id = $2 and delivery.session_id = $3
	and a.project_id = $1 and a.chat_id = $2 and a.session_id = $3
	and delivery.turn_id = $4 and delivery.idempotency_key = $5;
