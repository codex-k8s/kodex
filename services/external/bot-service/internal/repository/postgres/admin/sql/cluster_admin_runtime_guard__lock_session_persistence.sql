-- name: cluster_admin_runtime_guard__lock_session_persistence :one
select true
...
join matter_codex_cluster_admin_session_bindings frozen_session
	on frozen_session.role_id = role.id
...
for share of project, role, subject, bot, frozen_bot, chat, binding, participant, frozen_session
