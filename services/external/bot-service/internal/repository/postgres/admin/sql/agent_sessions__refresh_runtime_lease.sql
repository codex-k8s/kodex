...
where session_row.session_key = $1
	...
	and session_row.runtime_reconcile_lease_token = $5
	and coalesce(session_row.runtime_reconcile_lease_revision_id, 0) = $2
	and session_row.runtime_reconcile_lease_expires_at > now()
	and not exists (
...
-- name: agent_sessions__refresh_runtime_lease :one
