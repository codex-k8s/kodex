...
func TestExactNMinusOneBinaryBootstrapsAfterV22ThroughV34Upgrade(t *testing.T) {
	...
	if version, err := migrations.Version(ctx, ownerDSN); err != nil || version != 36 {
...
func TestForwardOnlyDownKeepsVersionAndUpIsIdempotent(t *testing.T) {
	...
	if err := migrations.DownOne(ctx, dsn); err == nil {
		t.Fatal("latest forward-only down unexpectedly succeeded")
	}
