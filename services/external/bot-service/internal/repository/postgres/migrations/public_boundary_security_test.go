...
func TestExactNMinusOneBinaryBootstrapsAfterV22V23V24V25V26V27V28V29V30V31Upgrade(t *testing.T) {
...
func TestPublicBoundaryMigrationUpgradePreservesConfiguredClusterAdmin(t *testing.T) {
	...
	if err := migrations.Run(ctx, dsn); err != nil {
		t.Fatalf("upgrade v22->v23->v24->v25->v26->v27->v28->v29->v30->v31->v32->v33->v34: %v", err)
	}
	pool = openMigrationPool(t, ctx, dsn)
	defer pool.Close()
	repository := postgresrepo.NewRepository(pool)
