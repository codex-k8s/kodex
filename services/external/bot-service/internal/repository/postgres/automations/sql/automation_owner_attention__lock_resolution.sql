...
where run.project_id = $1
	...
	and attention.automation_mattermost_post_create_at > 0
	and $6 > attention.automation_mattermost_post_create_at
	...
	and (
		(
			...
			and attention.automation_response_post_create_at = $6
		)
		or (
