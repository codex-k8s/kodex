...
//go:embed prompt_seeds/*.md prompt_seeds/history/v1/*.md prompt_seeds/history/v2/*.md prompt_seeds/history/v3/*.md prompt_seeds/history/v4/*.md prompt_seeds/history/v5/*.md
...
func promptSeedCatalog() []promptTemplateSeed {
	seeds := []promptTemplateSeed{
		...
		},
		{
			...
			Version:       6,
			PreviousFiles: []string{"history/v1/manager_coordinate_task.md", "history/v2/manager_coordinate_task.md", "history/v3/manager_coordinate_task.md", "history/v4/manager_coordinate_task.md", "history/v5/manager_coordinate_task.md"},
		},
		{
