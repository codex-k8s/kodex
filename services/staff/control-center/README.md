...
| Voice скрыт в disabled workflow fields                                                            | `src/pages/WorkflowDetailPage.vue`                                                              | Передача disabled проверена в коде; отдельный browser case этой формы ещё NOT RUN                                                                |
