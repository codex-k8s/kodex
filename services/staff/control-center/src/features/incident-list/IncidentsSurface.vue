...
} from "@/features/incident-list/details-store";
...
const incidents = useIncidentListStore();
...
<template>
  <div class="page">
    ...
    <AsyncPanel
      :phase="incidents.incidents.phase"
      :problem="incidents.incidents.problem"
      @retry="incidents.load"
      ><section class="panel" style="margin-top: 15px">
        <div class="data-table-wrap">
          <table class="data-table">
            ...
            <tbody>
              <tr
                v-for="item in incidents.incidents.data"
