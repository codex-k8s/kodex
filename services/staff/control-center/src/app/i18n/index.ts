...
import { restoreRevisionMessages } from "@/features/managed-configurations/restore-revision-messages";
...
const ru = {
  ...
  automationPreview: automationPreviewMessages.ru,
  providerUsage: providerUsageMessages.ru,
  ...
  templateAvailability: {
    REVISION_NOT_SAVED: "Будет назначена после сохранения",
    AVAILABLE: "Доступна",
  ...
  vfs: {
    ...
    selectNode: "Выбрать: {name}",
    download: "Скачать",
    bulkAction: {
      REMOVE: "В корзину / архив",
      RESTORE: "Восстановить",
    ...
    confirmTitle: "Подтверждение действий",
    confirmDescription:
      "Каждый объект изменяется отдельно с проверкой выбранной версии и текущих разрешений. Удаление навсегда необратимо. При ошибке автоматического повтора нет.",
    confirm: "Подтвердить для {count} объектов",
    version: "Версия {version}, ревизия {revision}",
    impact: "Связей: {bindings}, вложений: {attachments}",
    results: "Результаты по объектам",
    selectionReason: {
      AVAILABLE: "Действия доступны",
      DIRECTORY: "Навигационная папка",
      PERMISSION_REQUIRED: "Недостаточно разрешений",
      IMMUTABLE_CONTEXT: "Неизменяемый входной контекст",
      LIFECYCLE_BLOCKED: "Действие недоступно в текущем состоянии",
      ARTIFACT_USED_BY_SKILL: "Файл используется навыком",
      ARTIFACT_NOT_ACTIVE: "Файл не активен",
      ARTIFACT_NOT_DELETED: "Файл не находится в корзине",
      ARTIFACT_HAS_BINDINGS: "У файла есть привязки",
      ACTIVE_RUN_USES_ARTIFACT: "Файл используется активным запуском",
    },
    refresh: "Обновить",
    folders: "Папки",
  ...
  voice: {
    ...
    rateLimitedWait:
      "Сервис ограничил частоту распознавания. Подождите минимум {seconds} с перед новой записью; автоматической повторной отправки нет.",
  },
  app: {
    name: "Kodex",
  ...
  common: {
    ...
    refresh: "Обновить",
    loadMore: "Загрузить ещё",
    rowsPerLoad: "Строк за загрузку",
    loadedRows: "Загружено: {count}",
  ...
  runtime: {
    environmentNotActive: "Окружение не активно.",
    environmentPublishedMissing: "Нет опубликованной версии окружения.",
    ...
    accountCatalogHelp:
      "Выберите записи, разрешённые в этом контексте. Совместимость модели проверяется отдельно. Внутренние идентификаторы вводить вручную нельзя.",
  ...
  workflows: {
    launchUnavailable: "Сервер не предоставил доступное действие запуска.",
    title: "Процессы",
  ...
  providers: {
    ...
    catalogExpired: "Срок проверки каталога истёк",
    catalogRemoteApi: "Каталог API провайдера",
    catalogRemoteCodex: "Каталог Codex провайдера",
    catalogUnavailable: "Проверка провайдера временно недоступна",
    catalogUnverified: "Источник каталога не подтверждён",
    catalogAuthorizationRejected: "Провайдер отклонил авторизацию",
    ...
    reasons: {
      ...
      ACCOUNT_DELETING: "Удаление ожидает зависимостей и очистки",
    ...
    selectedCount: "Выбрано: {count}",
    noEligibleAccounts:
      "Нет учётных записей для выбранного провайдера и контекста.",
  ...
  assistant: {
    ...
    contextOperations: "Доступные команды:",
    contextReadOnly: "Только чтение контекста",
...
const en = {
  ...
  automationPreview: automationPreviewMessages.en,
  providerUsage: providerUsageMessages.en,
  ...
  vfs: {
    ...
    confirmDescription:
      "Each resource is changed separately using its selected version and current permissions. Permanent deletion cannot be undone. Failed operations are not retried automatically.",
    confirm: "Confirm for {count} resources",
    version: "Version {version}, revision {revision}",
    impact: "Bindings: {bindings}, attachments: {attachments}",
    results: "Results by resource",
    selectionReason: {
      AVAILABLE: "Actions available",
      DIRECTORY: "Navigation folder",
      PERMISSION_REQUIRED: "Permission required",
      IMMUTABLE_CONTEXT: "Immutable input context",
      LIFECYCLE_BLOCKED: "Action unavailable in the current state",
      ARTIFACT_USED_BY_SKILL: "File is used by a skill",
      ARTIFACT_NOT_ACTIVE: "File is not active",
      ARTIFACT_NOT_DELETED: "File is not in the trash",
      ARTIFACT_HAS_BINDINGS: "File has bindings",
      ACTIVE_RUN_USES_ARTIFACT: "File is used by an active run",
    },
    refresh: "Refresh",
    folders: "Folders",
  ...
  templateAvailability: {
    AVAILABLE: "Available",
    REVISION_NOT_SAVED: "Assigned after saving",
  ...
  voice: {
    ...
    rateLimitedWait:
      "The transcription service rate limit was reached. Wait at least {seconds} s before recording again; the request is not retried automatically.",
  },
  app: {
    ...ru.app,
  ...
  runtime: {
    ...ru.runtime,
    environmentNotActive: "The environment is not active.",
    environmentPublishedMissing: "The environment has no published version.",
    ...
    accountCatalogHelp:
      "Select accounts allowed for this context. Model compatibility is checked separately. Internal identifiers cannot be entered manually.",
  ...
  workflows: {
    ...ru.workflows,
    launchUnavailable:
      "The server has not provided an available launch action.",
    title: "Processes",
  ...
  providers: {
    ...
    catalogExpired: "Catalog check expired",
    catalogRemoteApi: "Provider API catalog",
    catalogRemoteCodex: "Provider Codex catalog",
    catalogUnavailable: "Provider check is temporarily unavailable",
    catalogUnverified: "Catalog source is unverified",
    catalogAuthorizationRejected: "Provider rejected authorization",
    ...
    reasons: {
      ...
      ACCOUNT_DELETING: "Deletion is waiting for dependencies and cleanup",
    ...
    authorized: "The account is authorized.",
    authorizationFailed:
    ...
    selectedCount: "Selected: {count}",
    noEligibleAccounts:
      "No accounts are available for the selected provider and context.",
  ...
  assistant: {
    ...
    contextOperations: "Available commands:",
    contextReadOnly: "Read-only context",
    contextOperationsUnknown:
