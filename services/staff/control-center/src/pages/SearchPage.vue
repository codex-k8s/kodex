...
const form = reactive({ kind: "PROJECT" as ResourceKind, query: "" });
...
function syncRoute(): void {
  const kind = String(route.query.kind ?? "PROJECT") as ResourceKind;
  form.kind = kinds.includes(kind) ? kind : "PROJECT";
      ...
      <AsyncPanel
        ...
        ><div class="data-table-wrap">
          <table class="data-table">
            ...
            <tbody>
              <tr v-for="item in store.results.data" :key="item.id">
