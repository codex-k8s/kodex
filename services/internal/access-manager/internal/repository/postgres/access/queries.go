...
var (
	...
	queryAccessRuleInsert                   = mustLoadQuery("access_rule__insert")
	...
	queryExternalProviderCreate             = mustLoadQuery("external_provider__create")
	...
	querySecretBindingRefInsert             = mustLoadQuery("secret_binding_ref__insert")
