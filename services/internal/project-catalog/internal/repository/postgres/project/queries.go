...
var (
	...
	queryDocumentationSourceMarkPolicyManagedDisabled = mustLoadQuery("documentation_source__mark_policy_managed_disabled")
	queryDocumentationSourceUpdate                    = mustLoadQuery("documentation_source__update")
	queryDocumentationSourceUpsertPolicy              = mustLoadQuery("documentation_source__upsert_policy")
