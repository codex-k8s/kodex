...
func ProjectOnboardingStatusToProto(status enum.ProjectOnboardingStatus) projectsv1.ProjectOnboardingStatus {
	switch status {
	case enum.ProjectOnboardingStatusReady:
		return projectsv1.ProjectOnboardingStatus_PROJECT_ONBOARDING_STATUS_READY
	case enum.ProjectOnboardingStatusInvalidInput:
		return projectsv1.ProjectOnboardingStatus_PROJECT_ONBOARDING_STATUS_INVALID_INPUT
	case enum.ProjectOnboardingStatusProjectNotFound:
		return projectsv1.ProjectOnboardingStatus_PROJECT_ONBOARDING_STATUS_PROJECT_NOT_FOUND
	case enum.ProjectOnboardingStatusProjectNotActive:
		return projectsv1.ProjectOnboardingStatus_PROJECT_ONBOARDING_STATUS_PROJECT_NOT_ACTIVE
	case enum.ProjectOnboardingStatusRepositoryBindingNotFound:
		return projectsv1.ProjectOnboardingStatus_PROJECT_ONBOARDING_STATUS_REPOSITORY_BINDING_NOT_FOUND
	case enum.ProjectOnboardingStatusRepositoryBindingConflict:
		return projectsv1.ProjectOnboardingStatus_PROJECT_ONBOARDING_STATUS_REPOSITORY_BINDING_CONFLICT
	case enum.ProjectOnboardingStatusRepositoryBindingNotActive:
		return projectsv1.ProjectOnboardingStatus_PROJECT_ONBOARDING_STATUS_REPOSITORY_BINDING_NOT_ACTIVE
	case enum.ProjectOnboardingStatusServicesPolicyNotFound:
		return projectsv1.ProjectOnboardingStatus_PROJECT_ONBOARDING_STATUS_SERVICES_POLICY_NOT_FOUND
	case enum.ProjectOnboardingStatusServicesPolicyNotReady:
		return projectsv1.ProjectOnboardingStatus_PROJECT_ONBOARDING_STATUS_SERVICES_POLICY_NOT_READY
	case enum.ProjectOnboardingStatusServicesPolicyStale:
		return projectsv1.ProjectOnboardingStatus_PROJECT_ONBOARDING_STATUS_SERVICES_POLICY_STALE
	case enum.ProjectOnboardingStatusServiceDescriptorsNotFound:
		return projectsv1.ProjectOnboardingStatus_PROJECT_ONBOARDING_STATUS_SERVICE_DESCRIPTORS_NOT_FOUND
	default:
		return projectsv1.ProjectOnboardingStatus_PROJECT_ONBOARDING_STATUS_UNSPECIFIED
	}
}
