...
var (
	...
	queryChannelCallbackCreate     = mustLoadQuery("channel_callback__create")
	queryChannelCallbackGet        = mustLoadQuery("channel_callback__get")
	queryChannelCallbackGetByID    = mustLoadQuery("channel_callback__get_by_callback_id")
	queryChannelCallbackLatest     = mustLoadQuery("channel_callback__latest")
