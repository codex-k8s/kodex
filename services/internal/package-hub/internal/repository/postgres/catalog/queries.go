...
var (
	...
	queryPackageInsertIgnore         = mustLoadQuery("package__insert_ignore")
	...
	queryPackageUpdateBySourceSlug   = mustLoadQuery("package__update_by_source_slug")
	...
	queryPackageVersionInsertIgnore  = mustLoadQuery("package_version__insert_ignore")
	...
	queryPackageVersionUpdateByLabel = mustLoadQuery("package_version__update_by_package_label")
