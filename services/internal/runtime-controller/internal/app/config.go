...
type Config struct {
	...
	RuntimeServiceAccount       string        `env:"RUNTIME_NONE_SERVICE_ACCOUNT"`
...
func loadConfig() (Config, error) {
	config := Config{
		...
		RuntimeServiceAccount: "runtime-role-none", ReadClusterRole: "runtime-role-project-read",
		AdminClusterRole: "cluster-admin", ArchiveServiceAccount: "runtime-controller",
		RestoreServiceAccount: "runtime-restore-verifier", CleanupServiceAccount: "runtime-cleanup-authorizer",
		MaximumPods: 100, MaximumCPUMilli: 100_000, MaximumMemoryBytes: 400 << 30,
