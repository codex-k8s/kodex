...
func TestMailEgressDestination(t *testing.T) {
	...
	for _, key := range []string{"EMAIL_BRIDGE_SECRETS_ROOT", "EMAIL_BRIDGE_DSN_FILE", "EMAIL_BRIDGE_CERTIFICATE_FILE", "EMAIL_BRIDGE_PRIVATE_KEY_FILE", "EMAIL_BRIDGE_CA_FILE", "EMAIL_BRIDGE_APPLICATION_GRANT_FILE"} {
