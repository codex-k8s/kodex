...
const (
	...
	operationEnsureSelfDeployPlanGate       = "domain.Service.EnsureSelfDeployPlanGovernanceGate"
	operationEnsureSelfDeployPlanRuntime    = "domain.Service.EnsureSelfDeployPlanRuntime"
