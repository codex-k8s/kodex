...
func acceptanceEvent(id uuid.UUID, eventType string, reasonCode string, acceptance entity.AcceptanceResult, occurredAt time.Time) (entity.OutboxEvent, error) {
	payload, err := json.Marshal(agentevents.Payload{
		...
		GovernanceGateRequestRef:            acceptance.GovernanceContext.GateRequestRef,
		GovernanceDecisionRef:               acceptance.GovernanceContext.GateDecisionRef,
		GovernanceRiskAssessmentRef:         acceptance.GovernanceContext.RiskAssessmentRef,
		GovernanceReleaseDecisionPackageRef: acceptance.GovernanceContext.ReleaseDecisionPackageRef,
		GovernanceReleaseDecisionRef:        acceptance.GovernanceContext.ReleaseDecisionRef,
		GovernanceRiskProfileRef:            acceptance.GovernanceContext.RiskProfileRef,
		GovernanceGatePolicyRef:             acceptance.GovernanceContext.GatePolicyRef,
		GovernanceReleasePolicyRef:          acceptance.GovernanceContext.ReleasePolicyRef,
...
func followUpEvent(id uuid.UUID, eventType string, reasonCode string, intent entity.FollowUpIntent, occurredAt time.Time) (entity.OutboxEvent, error) {
	payload, err := json.Marshal(agentevents.Payload{
		...
		GovernanceGateRequestRef:            intent.GovernanceContext.GateRequestRef,
		GovernanceDecisionRef:               intent.GovernanceContext.GateDecisionRef,
		GovernanceRiskAssessmentRef:         intent.GovernanceContext.RiskAssessmentRef,
		GovernanceReleaseDecisionPackageRef: intent.GovernanceContext.ReleaseDecisionPackageRef,
		GovernanceReleaseDecisionRef:        intent.GovernanceContext.ReleaseDecisionRef,
		GovernanceRiskProfileRef:            intent.GovernanceContext.RiskProfileRef,
		GovernanceGatePolicyRef:             intent.GovernanceContext.GatePolicyRef,
		GovernanceReleasePolicyRef:          intent.GovernanceContext.ReleasePolicyRef,
...
func humanGateEvent(id uuid.UUID, eventType string, reasonCode string, gate entity.HumanGateRequest, occurredAt time.Time) (entity.OutboxEvent, error) {
	payload, err := json.Marshal(agentevents.Payload{
		...
		GovernanceRiskAssessmentRef:         gate.GovernanceContext.RiskAssessmentRef,
		GovernanceReleaseDecisionPackageRef: gate.GovernanceContext.ReleaseDecisionPackageRef,
		GovernanceReleaseDecisionRef:        gate.GovernanceContext.ReleaseDecisionRef,
		GovernanceRiskProfileRef:            gate.GovernanceContext.RiskProfileRef,
		GovernanceGatePolicyRef:             gate.GovernanceContext.GatePolicyRef,
		GovernanceReleasePolicyRef:          gate.GovernanceContext.ReleasePolicyRef,
