...
const (
	...
	SelfDeployGateRecoveryCodeExistingRiskAccessDenied         = "existing_risk_access_denied"
	SelfDeployGateRecoveryCodeExistingGateLookupFailed         = "existing_gate_lookup_failed"
	SelfDeployGateRecoveryCodeExistingGateRequestLookupFailed  = "existing_gate_request_lookup_failed"
	SelfDeployGateRecoveryCodeExistingGateRequestAccessDenied  = "existing_gate_request_access_denied"
	SelfDeployGateRecoveryCodeExistingGateDecisionLookupFailed = "existing_gate_decision_lookup_failed"
	SelfDeployGateRecoveryCodeExistingGateDecisionAccessDenied = "existing_gate_decision_access_denied"
	SelfDeployGateRecoveryCodeExistingGateDecisionNotFound     = "existing_gate_decision_not_found"
	SelfDeployGateRecoveryCodeExistingGateDecisionMismatch     = "existing_gate_decision_mismatch"
