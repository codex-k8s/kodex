...
INSERT INTO agent_manager_human_gate_requests (
    ...
    governance_decision_ref, governance_risk_assessment_ref,
    governance_release_decision_package_ref, governance_release_decision_ref,
    governance_risk_profile_ref, governance_gate_policy_ref,
    governance_release_policy_ref, idempotency_key, status, outcome, version,
