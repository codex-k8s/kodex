-- name: human_gate_request__update :exec
UPDATE agent_manager_human_gate_requests
SET
    run_id = @run_id::uuid,
    ...
    interaction_request_ref = @interaction_request_ref,
    interaction_response_ref = @interaction_response_ref,
