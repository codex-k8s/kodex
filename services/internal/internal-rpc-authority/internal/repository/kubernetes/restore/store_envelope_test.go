...
func TestDecodeConfigMapEnvelopeAcceptsKubernetesObjectMetadata(t *testing.T) {
	const raw = `{"apiVersion":"v1","data":{"state.json":""},"kind":"ConfigMap","metadata":{"creationTimestamp":"2026-08-12T00:00:00Z","labels":{"app.kubernetes.io/name":"internal-rpc-authority"},"name":"internal-rpc-authority-restore-coordination","namespace":"mattercodex-system","resourceVersion":"42","uid":"00000000-0000-4000-8000-000000000001"}}`
