...
var (
	queryRepositoryMergeSignalGet             = mustLoadQuery("repository_merge_signal__get")
	...
	queryRepositoryMergeSignalList            = mustLoadQuery("repository_merge_signal__list")
	queryRepositoryChangeSignalGet            = mustLoadQuery("repository_change_signal__get")
	queryRepositoryChangeSignalGetByKey       = mustLoadQuery("repository_change_signal__get_by_key")
	queryRepositoryChangeSignalInsert         = mustLoadQuery("repository_change_signal__insert")
	queryRepositoryChangeSignalList           = mustLoadQuery("repository_change_signal__list")
	queryRepositoryAdoptionScanGet            = mustLoadQuery("repository_adoption_scan__get")
	...
	queryRepositoryAdoptionScanList           = mustLoadQuery("repository_adoption_scan__list")
