...
func expectedOperations() map[string]string {
	return map[string]string{
		...
		"interaction.agent-bot.catalog.read":                     interactiongatewayv1.AgentMattermostBotIdentityService_ListAgentMattermostBotIdentities_FullMethodName,
		"interaction.agent-bot.create-and-bind":                  interactiongatewayv1.AgentMattermostBotIdentityService_CreateAndBindAgentMattermostBotIdentity_FullMethodName,
		"interaction.agent-bot.bind":                             interactiongatewayv1.AgentMattermostBotIdentityService_BindAgentMattermostBotIdentity_FullMethodName,
		"interaction.agent-bot.get":                              interactiongatewayv1.AgentMattermostBotIdentityService_GetAgentMattermostBotIdentity_FullMethodName,
		"interaction.agent-bot.rebind":                           interactiongatewayv1.AgentMattermostBotIdentityService_RebindAgentMattermostBotIdentity_FullMethodName,
		"interaction.agent-bot.revoke":                           interactiongatewayv1.AgentMattermostBotIdentityService_RevokeAgentMattermostBotIdentity_FullMethodName,
		"interaction.agent-bot.operation.get":                    interactiongatewayv1.AgentMattermostBotIdentityService_GetAgentMattermostBotIdentityOperation_FullMethodName,
		"interaction.agent-bot.provider.readback":                interactiongatewayv1.AgentMattermostBotIdentityService_GetAgentMattermostBotIdentityProviderReadback_FullMethodName,
		"interaction.agent-bot.readiness":                        interactiongatewayv1.AgentMattermostBotIdentityService_CheckAgentMattermostBotIdentityReadiness_FullMethodName,
