...
func producerAuthoritySource(producer Producer) string {
	...
	case "MATTERMOST_PROVIDER_READBACK_RECEIPT", "AI_PROVIDER_READBACK_RECEIPT":
		return "PROVIDER_READBACK"
	case "GIT_RECONCILIATION_RECEIPT":
		return "GIT_RECONCILIATION"
...
func supportedCredential(credential string) bool {
	...
	case "OIDC_BEARER",
		...
		"MATTERMOST_PROVIDER_READBACK_RECEIPT",
		"AI_PROVIDER_READBACK_RECEIPT",
		"GIT_RECONCILIATION_RECEIPT",
		"AGENT_SESSION_GRANT",
		"AUTOMATION_OCCURRENCE_GRANT",
		"LEGACY_DATA_MIGRATION_GRANT",
		"PROCESS_RUN_GRANT",
		"OWNER_GATE_DELIVERY_GRANT",
		"RUNTIME_REVISION_GRANT",
		"RUNTIME_ARCHIVE_GRANT",
		"RUNTIME_RESTORE_VERIFIER_GRANT",
		"RUNTIME_RESTORE_EFFECT_GRANT",
