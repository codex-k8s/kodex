...
func defaultTemplateVars() map[string]string {
	return map[string]string{
		...
		"CODEXK8S_WORKER_NAMESPACE_LEASE_SWEEP_LIMIT":                      "200",
		"CODEXK8S_WORKER_NAMESPACE_CLEANUP_CRON_SCHEDULE":                  "*/15 * * * *",
		"CODEXK8S_WORKER_NAMESPACE_CLEANUP_CRON_SUSPEND":                   "false",
		"CODEXK8S_WORKER_NAMESPACE_CLEANUP_CRON_STARTING_DEADLINE_SECONDS": "300",
		"CODEXK8S_WORKER_NAMESPACE_CLEANUP_CRON_SUCCESS_HISTORY_LIMIT":     "1",
		"CODEXK8S_WORKER_NAMESPACE_CLEANUP_CRON_FAILED_HISTORY_LIMIT":      "3",
		"CODEXK8S_WORKER_NAMESPACE_CLEANUP_CRON_ACTIVE_DEADLINE_SECONDS":   "900",
