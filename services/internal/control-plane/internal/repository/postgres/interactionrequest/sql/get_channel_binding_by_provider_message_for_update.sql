-- name: interactionrequest__get_channel_binding_by_provider_message_for_update :one
SELECT
    id,
...
WHERE adapter_kind = 'telegram'
  AND provider_chat_ref = $1
  AND provider_message_ref_json->>'message_id' = $2
FOR UPDATE;
