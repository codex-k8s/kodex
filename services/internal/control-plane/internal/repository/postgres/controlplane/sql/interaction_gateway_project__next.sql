-- name: InteractionGatewayProjectNext
WITH cursor_row AS (
    INSERT INTO control_plane.interaction_gateway_cursors (
    ...
    ON CONFLICT (organization_id, operation) DO UPDATE
      SET updated_at = control_plane.interaction_gateway_cursors.updated_at
    ...
    UPDATE control_plane.interaction_gateway_cursors AS cursor
