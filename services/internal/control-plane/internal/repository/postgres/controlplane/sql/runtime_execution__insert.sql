...
INSERT INTO control_plane.runtime_executions (
    ...
    restore_source_immutable_input_sha256, restore_source_proof_reference,
    restore_source_proof_sha256, restore_source_version, restore_source_fence,
    ...
    nullif(@restore_source_proof_reference, ''),
    nullif(@restore_source_proof_sha256, ''),
    nullif(@restore_source_version, 0), nullif(@restore_source_fence, 0),
    nullif(@restore_source_archive_object_key, ''),
