...
INSERT INTO control_plane.runtime_restore_operations (
    ...
    source_authority_sha256, session_id, generation, consumed_generation, revoked_generation,
    target_turn_id, target_attempt, target_execution_id,
    ...
    @source_authority_sha256, @session_id::uuid, @generation, @consumed_generation, @revoked_generation,
    @target_turn_id::uuid, @target_attempt, @target_execution_id::uuid,
    @created_at, @updated_at
);
