...
INSERT INTO control_plane.integration_invocations(
	...
	approval_policy,resource_kind,resource_scope,resource_scope_digest,effect_key,mailbox_gate_required,approval_scope_id,
	grant_version,approval_scope_paths
)
