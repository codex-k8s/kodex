-- name: queries_attachconversation_select_assistant_plans_organization_id_ref :many
...
JOIN control_plane.assistant_conversations c
  ON c.organization_id=p.organization_id
 AND c.ref=p.conversation_ref
LEFT JOIN LATERAL (
