...
SELECT l.id::text,l.run_id::text,l.node_id::text,r.root_run_id::text,COALESCE(r.project_id::text,''),COALESCE(p.ref,''),r.ref,n.ref,l.fence_digest,l.generation,l.state,l.expires_at,COALESCE(t.ref,'')
