...
var (
	...
	//go:embed sql/runtime_completeexecution_update_schedules_last_run_at_updated_at.sql
	queryRuntimeCompleteexecutionUpdateSchedulesLastRunAtUpdatedAt string
