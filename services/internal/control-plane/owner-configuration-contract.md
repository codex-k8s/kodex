...
readiness до каждого нового Put через `ListObjectVersions` bounded удаляет и
...
ambiguous commit и превышение bounds закрывают readiness на любой replica. Unit также владеет outbox relay,
