...
func TestCommonNameMatchesVaultSubdomainRole(t *testing.T) {
	...
	if commonName != "6ba7078c0476fe89.g7.mattercodex-node-pull" {
...
func TestCommonNameValidationRejectsExpandedIdentity(t *testing.T) {
	...
	for _, testCase := range []struct {
		...
		{"mattercodex-node-pull-3bd0c4f120d4bf48-g7", 7},
		{"3bd0c4f120d4bf48.g8.mattercodex-node-pull", 7},
		{"3bd0c4f120d4bf4.g7.mattercodex-node-pull", 7},
		{"3BD0C4F120D4BF48.g7.mattercodex-node-pull", 7},
		{"3bd0c4f120d4bf48.g7.other-node-pull", 7},
		{"3bd0c4f120d4bf48.g7.mattercodex-node-pull", 0},
	} {
