...
var sourceProjectionKeys = map[string][]string{
	"matter_codex_projects":    {"id", "slug", "mattermost_team_id", "github_account_name"},
	"matter_codex_chats":       {"id", "project_id", "mattermost_channel_id", "slug", "status"},
	"matter_codex_agent_roles": {"id", "project_id", "name", "github_account_name", "openai_account_name", "bot_identity", "prompt_mode", "enabled"},
	...
	"matter_codex_agent_session_turns":    {"id", "session_id", "run_id", "status", "binding_version", "artifacts"},
