...
## 8. Визуальные варианты рабочих пространств

### Вариант A
Рабочее пространство `Issue` с упором на диалог и правую колонку контекста: связанные `PR`, решения, `run`, `job` и slot.

![Вариант A рабочего пространства](images/wave5-workspace-variant-a.png)

### Вариант B
Рабочее пространство с упором на следующее действие: отдельно задача, отдельно `PR`, отдельно исполнения и среда.

![Вариант B рабочего пространства](images/wave5-workspace-variant-b.png)

## 9. Что wave 5 deliberately не фиксирует
