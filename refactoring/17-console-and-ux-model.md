...
- как редактируются flow, роли и шаблоны промптов, если источником правды остаётся репозиторий.
...
| Настройка и automation | как заданы flow, release policy, правила расписания, triggers и каналы | flow, release line, automation rule, внешний аккаунт, канал |
