...
Полный пакет утверждённых и готовых к review макетов wave 5 находится в [refactoring/images/wave5/index.md](images/wave5/index.md). Для экранов с вкладками рядом с основным состоянием лежат отдельные PNG по каждой вкладке.
