...
- Конфигурирование flow, ролей, шаблонов промптов, внешних аккаунтов и каналов связи выносится в отдельный настроечный контур с изменением через `PR/MR` в целевых репозиториях конфигурации.
...
- как редактируются flow, роли и шаблоны промптов, если источником правды остаются репозитории конфигурации.
...
| Настройка и automation | как заданы flow, release policy, правила расписания, triggers и каналы | flow, release line, automation rule, внешний аккаунт, канал, репозиторий конфигурации |
...
- репозитории конфигурации для flow, ролей и шаблонов промптов;
