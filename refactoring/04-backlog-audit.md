...
| #488 | Delivery governance | закрыть как поглощённую | compact PR policy и `prototype -> production conversion` уже вошли в канонику программы | `refactoring/01-program-charter.md`, `refactoring/05-delivery-and-risk-principles.md`, `docs/delivery/development_process_requirements.md` |
