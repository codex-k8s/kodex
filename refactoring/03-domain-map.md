...
- шаблоны документации живут отдельно от руководящих пакетов, публичный источник шаблонов — `github.com/codex-k8s/kodex-doc-templates`, а в `kodex` хранится рабочая локальная копия;
