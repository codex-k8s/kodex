...
- граф проектной документации по нескольким репозиториям;
- репозитории конфигурации flow, ролей и шаблонов промптов;
- branch rules;
- release policies;
...
- ссылки на репозиторные файлы flow и шаблонов ролей, используемые при запуске.
...
- flow и шаблоны ролей живут в репозиториях конфигурации и меняются через `PR/MR`.
