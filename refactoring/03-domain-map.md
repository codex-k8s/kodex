...
- пакеты, доступные проекту или установке, описываются в `services.yaml` и checkout-ятся в `packages/**` по зафиксированному `tag` или `commit`; платные пакеты проходят через прокси платформы и проверку прав.
