...
До 27 июля 2026 года активен режим `prototype-accelerated` из
[ROAD-MC-007](accelerated-mvp-prototype.md): до шести независимых волн,
один reviewer pass, один security pass, один цикл исправления blocker и
post-merge аудит в backlog. Зависимости данных и контрактов сохраняются.
...
- ежедневный `improver` по новым материальным замечаниям без рекурсивного запуска из-за слияния собственного результата и расписания проверки платформы.
