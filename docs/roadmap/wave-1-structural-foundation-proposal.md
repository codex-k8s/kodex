...
- `000025`, `000026`, `000027`, `000028`, `000029`, `000031` и `000032` являются forward-only. Каждый `down` fail-closed, а rollback приложения разрешён только на заранее проверенный exact N-1 reader/runtime при отключённом callback route, без удаления scoped fence/outbox/manifest/triggers/functions, восстановления удаленных identity placeholders и без отката мер PR #74/#75.
