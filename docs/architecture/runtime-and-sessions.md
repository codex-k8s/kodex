...
- Перед повторным использованием pod контроллер сравнивает не только session
  token, но и точные ревизии OpenAI и GitHub Secret. Несовпадение удаляет
  простаивающий pod; следующий ход получает новую среду, не меняя Codex
  session binding.
