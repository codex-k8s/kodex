...
| `OwnerAttentionRequest` | process/turn, optional exact ScheduledRun/project/policy/root snapshot, server-owned delivery id/payload/hash/post binding и `CreateAt` карточки/ответа, confirmation-only fence, state, resolved_at, resolved_by_user/post |
