...
- Канонический PRD-артефакт Day1: `docs/deprecated/pre-refactor/delivery/epics/s5/prd-s5-day1-launch-profiles-and-stage-launcher-ux.md` (по шаблону `docs/templates/prd.md`).
