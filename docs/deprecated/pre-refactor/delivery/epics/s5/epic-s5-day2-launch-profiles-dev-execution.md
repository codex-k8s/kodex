...
- Источники требований и архитектурных ограничений:
  - `docs/deprecated/pre-refactor/delivery/epics/s5/epic-s5-day1-launch-profiles-and-stage-launcher-ux.md`
  - `docs/deprecated/pre-refactor/delivery/epics/s5/prd-s5-day1-launch-profiles-and-stage-launcher-ux.md`
...
## Связанные артефакты
- `docs/deprecated/pre-refactor/delivery/sprints/s5/sprint_s5_stage_entry_and_label_ux.md`
- `docs/deprecated/pre-refactor/delivery/epics/s5/epic_s5.md`
