...
## Зависимости
- Требует базовой модели конфигов и fallback кредов из `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day13-config-and-credentials-governance.md`.
- Domain preflight должен быть согласован с full-env `domainTemplate` из `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day11-full-env-slots-and-subdomains.md`.
