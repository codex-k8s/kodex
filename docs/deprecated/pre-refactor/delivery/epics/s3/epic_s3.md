...
## Эпики Sprint S3
- Day 1: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day1-full-stage-and-label-activation.md`
- Day 2: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day2-staff-runtime-debug-console.md`
- Day 3: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day3-mcp-deterministic-secret-sync.md`
- Day 4: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day4-mcp-database-lifecycle.md`
- Day 5: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day5-feedback-and-approver-interfaces.md`
- Day 6: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day6-self-improve-ingestion-and-diagnostics.md`
- Day 7: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day7-self-improve-updater-and-pr-flow.md`
- Day 8: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day8-agent-toolchain-auto-extension.md`
- Day 9: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day9-declarative-full-env-deploy-and-runtime-parity.md`
- Day 10: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day10-staff-console-vuetify-redesign.md`
- Day 11: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day11-full-env-slots-and-subdomains.md`
- Day 12: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day12-docset-import-and-safe-sync.md`
- Day 13: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day13-config-and-credentials-governance.md`
- Day 14: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day14-repository-onboarding-preflight.md`
- Day 15: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day15-mvp-closeout-and-handover.md`
- Day 16: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day16-grpc-transport-boundary-hardening.md`
- Day 17: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day17-environment-scoped-secret-overrides-and-oauth-callbacks.md`
- Day 18: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day18-runtime-error-journal-and-staff-alert-center.md`
- Day 19: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day19-frontend-manual-qa-hardening-loop.md`
- Day 19.5: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day19.5-realtime-event-bus-and-websocket-backplane.md`
- Day 19.6: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day19.6-staff-realtime-subscriptions-and-ui.md`
- Day 19.7: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day19.7-run-namespace-ttl-and-revise-reuse.md`
- Day 20: `docs/deprecated/pre-refactor/delivery/epics/s3/epic-s3-day20-e2e-regression-and-mvp-closeout.md`
