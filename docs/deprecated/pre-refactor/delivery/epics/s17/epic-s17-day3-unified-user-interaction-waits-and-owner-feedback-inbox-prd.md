...
- Входной product contract:
  - `docs/deprecated/pre-refactor/delivery/sprints/s10/sprint_s10_mcp_user_interactions.md`;
  - `docs/deprecated/pre-refactor/delivery/sprints/s11/sprint_s11_telegram_user_interaction_adapter.md`;
