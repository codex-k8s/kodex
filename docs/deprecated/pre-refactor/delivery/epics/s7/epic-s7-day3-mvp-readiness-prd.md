...
## Контекст
- Intake baseline: `#212` (`docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day1-mvp-readiness-intake.md`).
- Vision baseline: `#218` (`docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day2-mvp-readiness-vision.md`).
