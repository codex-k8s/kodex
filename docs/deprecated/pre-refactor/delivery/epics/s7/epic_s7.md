...
## Stage roadmap
- Day 1 (Intake): `docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day1-mvp-readiness-intake.md` (Issue `#212`).
- Day 2 (Vision): `docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day2-mvp-readiness-vision.md` (Issue `#218`).
- Day 3 (PRD): `docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day3-mvp-readiness-prd.md` + `docs/deprecated/pre-refactor/delivery/epics/s7/prd-s7-day3-mvp-readiness-gap-closure.md` (Issue `#220`).
- Day 4 (Architecture): `docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day4-mvp-readiness-arch.md` (Issue `#222`).
- Day 5 (Design): `docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day5-mvp-readiness-design.md` (Issue `#238`).
- Day 6 (Plan): `docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day6-mvp-readiness-plan.md` (Issue `#241`).
