...
## Контекст
- Intake baseline: `#333` (`docs/deprecated/pre-refactor/delivery/epics/s9/epic-s9-day1-mission-control-dashboard-intake.md`).
- Vision baseline: `#335` (`docs/deprecated/pre-refactor/delivery/epics/s9/epic-s9-day2-mission-control-dashboard-vision.md`).
- PRD baseline: `#337` (`docs/deprecated/pre-refactor/delivery/epics/s9/epic-s9-day3-mission-control-dashboard-prd.md`, `docs/deprecated/pre-refactor/delivery/epics/s9/prd-s9-day3-mission-control-dashboard.md`).
- Architecture baseline: `#340` (`docs/deprecated/pre-refactor/delivery/epics/s9/epic-s9-day4-mission-control-dashboard-arch.md` + architecture package).
