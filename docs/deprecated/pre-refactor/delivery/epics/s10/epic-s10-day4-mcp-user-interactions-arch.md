...
## Контекст
- Intake baseline: `#360` (`docs/deprecated/pre-refactor/delivery/epics/s10/epic-s10-day1-mcp-user-interactions-intake.md`).
- Vision baseline: `#378` (`docs/deprecated/pre-refactor/delivery/epics/s10/epic-s10-day2-mcp-user-interactions-vision.md`).
- PRD baseline: `#383` (`docs/deprecated/pre-refactor/delivery/epics/s10/epic-s10-day3-mcp-user-interactions-prd.md`, `docs/deprecated/pre-refactor/delivery/epics/s10/prd-s10-day3-mcp-user-interactions.md`).
