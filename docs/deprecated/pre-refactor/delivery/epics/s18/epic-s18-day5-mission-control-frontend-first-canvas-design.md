...
## Контекст
- Intake baseline: `#562` (`docs/deprecated/pre-refactor/delivery/epics/s18/epic-s18-day1-mission-control-frontend-first-canvas-intake.md`).
- Vision baseline: `#565` (`docs/deprecated/pre-refactor/delivery/epics/s18/epic-s18-day2-mission-control-frontend-first-canvas-vision.md`).
- PRD baseline: `#567` (`docs/deprecated/pre-refactor/delivery/epics/s18/epic-s18-day3-mission-control-frontend-first-canvas-prd.md`, `docs/deprecated/pre-refactor/delivery/epics/s18/prd-s18-day3-mission-control-frontend-first-canvas.md`).
- Architecture baseline: `#571` (`docs/deprecated/pre-refactor/delivery/epics/s18/epic-s18-day4-mission-control-frontend-first-canvas-arch.md` + architecture package).
