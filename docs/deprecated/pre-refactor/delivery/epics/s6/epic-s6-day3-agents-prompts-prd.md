...
- Подготовлен отдельный PRD-артефакт: `docs/deprecated/pre-refactor/delivery/epics/s6/prd-s6-day3-agents-prompts-lifecycle.md`.
...
## Трассируемость
- Intake: `#184` -> `docs/deprecated/pre-refactor/delivery/epics/s6/epic-s6-day1-agents-prompts-intake.md`.
- Vision: `#185` (handover baseline для PRD).
- PRD: `#187` -> `docs/deprecated/pre-refactor/delivery/epics/s6/prd-s6-day3-agents-prompts-lifecycle.md`.
