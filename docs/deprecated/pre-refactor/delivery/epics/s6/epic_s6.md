...
## Эпики Sprint S6
- Day 1 (Intake): `docs/deprecated/pre-refactor/delivery/epics/s6/epic-s6-day1-agents-prompts-intake.md`
- Day 2 (Vision baseline): `docs/deprecated/pre-refactor/delivery/epics/s6/epic-s6-day2-agents-prompts-vision.md` (Issue `#185`).
- Day 3 (PRD):
...
- Day 4 (Architecture): `docs/deprecated/pre-refactor/delivery/epics/s6/epic-s6-day4-agents-prompts-arch.md` (Issue `#189`).
- Day 5 (Design): `docs/deprecated/pre-refactor/delivery/epics/s6/epic-s6-day5-agents-prompts-design.md` (Issue `#195`).
- Day 6 (Plan): `docs/deprecated/pre-refactor/delivery/epics/s6/epic-s6-day6-agents-prompts-plan.md` (Issue `#197`).
- Day 9 (Release closeout): `docs/deprecated/pre-refactor/delivery/epics/s6/epic-s6-day9-release-closeout.md` (Issue `#262`).
- Day 10 (Postdeploy review): `docs/deprecated/pre-refactor/delivery/epics/s6/epic-s6-day10-postdeploy-review.md` (Issue `#263`).
- Day 11 (Ops closeout): `docs/deprecated/pre-refactor/delivery/epics/s6/epic-s6-day11-ops-operational-closeout.md` (Issue `#265`).
