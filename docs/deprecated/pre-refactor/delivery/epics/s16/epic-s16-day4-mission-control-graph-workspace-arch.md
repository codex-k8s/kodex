...
## Контекст
- Intake baseline: `#492` (`docs/deprecated/pre-refactor/delivery/epics/s16/epic-s16-day1-mission-control-graph-workspace-intake.md`).
- Vision baseline: `#496` (`docs/deprecated/pre-refactor/delivery/epics/s16/epic-s16-day2-mission-control-graph-workspace-vision.md`).
- PRD baseline: `#510` (`docs/deprecated/pre-refactor/delivery/epics/s16/epic-s16-day3-mission-control-graph-workspace-prd.md`, `docs/deprecated/pre-refactor/delivery/epics/s16/prd-s16-day3-mission-control-graph-workspace.md`).
