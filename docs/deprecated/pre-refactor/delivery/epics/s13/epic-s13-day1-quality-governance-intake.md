...
- Текущий репозиторий уже содержит важные reference baselines, которые нельзя переизобретать:
  ...
  - Sprint S9 Mission Control (`docs/deprecated/pre-refactor/delivery/epics/s9/epic_s9.md`, `docs/delivery/traceability/s9_mission_control_dashboard_history.md`) для quality surfaces и operator decision UX;
