...
## Контекст
- Intake baseline: `#361` (`docs/deprecated/pre-refactor/delivery/epics/s11/epic-s11-day1-telegram-user-interaction-adapter-intake.md`).
- Vision baseline: `#447` (`docs/deprecated/pre-refactor/delivery/epics/s11/epic-s11-day2-telegram-user-interaction-adapter-vision.md`).
- PRD baseline: `#448` (`docs/deprecated/pre-refactor/delivery/epics/s11/epic-s11-day3-telegram-user-interaction-adapter-prd.md`, `docs/deprecated/pre-refactor/delivery/epics/s11/prd-s11-day3-telegram-user-interaction-adapter.md`).
- Architecture baseline: `#452` (`docs/deprecated/pre-refactor/delivery/epics/s11/epic-s11-day4-telegram-user-interaction-adapter-arch.md` + architecture package).
