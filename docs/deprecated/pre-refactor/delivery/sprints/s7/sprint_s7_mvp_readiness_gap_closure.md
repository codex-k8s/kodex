...
|---|---|---|---|---|
| Day 1 | Intake по MVP readiness gaps | P0 | `docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day1-mvp-readiness-intake.md` | in-review (`#212`) |
| Day 2 | Vision: целевая картина MVP closeout, KPI и decomposition baseline | P0 | `docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day2-mvp-readiness-vision.md` | in-review (`#218`) |
| Day 3 | PRD: FR/AC/NFR и sequencing для gap-closure streams | P0 | `docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day3-mvp-readiness-prd.md` + `docs/deprecated/pre-refactor/delivery/epics/s7/prd-s7-day3-mvp-readiness-gap-closure.md` | in-review (`#220`) |
| Day 4 | Architecture: границы и ownership по stream'ам | P0 | `docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day4-mvp-readiness-arch.md` | in-review (`#222`) |
| Day 5 | Design: execution-ready contracts/data/migrations package | P0 | `docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day5-mvp-readiness-design.md` (`#238`) | in-review (`#238`) |
| Day 6 | Plan: execution package и quality gates | P0 | `docs/deprecated/pre-refactor/delivery/epics/s7/epic-s7-day6-mvp-readiness-plan.md` (`#241`) | in-review (`#241`) |
