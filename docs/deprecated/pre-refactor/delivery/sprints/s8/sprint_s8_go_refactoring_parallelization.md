...
## Stage roadmap
- Day 1 (Plan): `docs/deprecated/pre-refactor/delivery/epics/s8/epic-s8-day1-go-refactoring-plan.md` (Issue `#223`).
- Day 2 (Execution): `docs/deprecated/pre-refactor/delivery/epics/s8/epic-s8-day2-empty-repository-initialization.md` (Issue `#281`).
- Day 3 (Execution): `docs/deprecated/pre-refactor/delivery/epics/s8/epic-s8-day3-existing-repository-adoption.md` (Issue `#282`).
- Day 4 (Plan): `docs/deprecated/pre-refactor/delivery/epics/s8/epic-s8-day4-documentation-ia-refactor-plan.md` (Issue `#320`).
