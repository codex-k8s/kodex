...
Технические и управленческие правила Kodex адаптированы из
`codex-k8s/project-template` на commit
`c354b23412ebc2b19e71d5b154ee1bcb905d9364`.

Копия правил в Kodex является нормативной для этого репозитория. Агенты
...
- продуктовые, доменные и архитектурные требования Kodex сохраняют свои
