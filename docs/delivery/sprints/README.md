...
| S7 | `docs/delivery/sprints/s7/sprint_s7_mvp_readiness_gap_closure.md` | `docs/delivery/epics/s7/epic_s7.md` | in-progress | Day1 intake (`#212`) и Day2 vision (`#218`) сформировали baseline, Day3 PRD (`#220`) зафиксировал FR/AC/NFR + sequencing по `S7-E01..S7-E18` и MVP policy `repo-only` по prompt templates (custom agents/prompt lifecycle вынесены в post-MVP), создана follow-up issue `#222` для `run:arch` без trigger-лейбла. |
