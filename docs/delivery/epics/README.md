...
related_issues: [112, 154, 184, 185, 187, 189, 195, 197, 199, 201, 212, 218, 220, 222, 238, 241, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 216, 262, 263, 265, 281, 282, 320, 327, 333, 335, 337, 340, 351, 360, 363, 369, 370, 371, 372, 373, 374, 375, 378]
related_prs: []
approvals:
  required: ["Owner"]
  status: pending
...
| `docs/delivery/epics/s10/` | Day1 intake + Day2 continuity issue для vision и каталог Sprint S10 вокруг built-in MCP user interactions, channel-neutral interaction-domain и follow-up adapter streams | `docs/delivery/epics/s10/epic_s10.md` |
