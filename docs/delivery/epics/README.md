...
| `docs/delivery/epics/s10/` | Day1 intake + Day2 vision + Day3 PRD package (`epic + prd`) по built-in MCP user interactions, channel-neutral interaction-domain, wait-state/correlation guardrails и continuity issue `#385` для architecture stage | `docs/delivery/epics/s10/epic_s10.md` |
