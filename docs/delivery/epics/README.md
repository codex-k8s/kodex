...
| `docs/delivery/epics/s10/` | Day1 intake + Day2 vision + Day3 PRD package (`epic + prd`) + Day4 architecture package (`epic + C4 overlays + ADR/alternatives`) по built-in MCP user interactions, channel-neutral interaction-domain, wait-state/correlation guardrails и design continuity issue `#387` | `docs/delivery/epics/s10/epic_s10.md` |
