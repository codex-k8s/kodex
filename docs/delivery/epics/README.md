...
| `docs/delivery/epics/s6/` | Day1..Day9 (intake + vision + PRD package + architecture + design + plan + release closeout) + каталог Sprint S6, continuity issue `#263` для postdeploy | `docs/delivery/epics/s6/epic_s6.md` |
