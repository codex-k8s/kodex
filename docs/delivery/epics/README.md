...
related_issues: [112, 154, 184, 185, 187, 189, 195, 197, 199, 201, 212, 218, 220, 222, 238, 241, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 216, 262, 263, 265, 281, 282, 320, 327, 333, 335, 337, 340, 351, 360, 363, 366, 369, 370, 371, 372, 373, 374, 375, 378, 383, 385, 387, 389, 391, 392, 393, 394, 395, 413]
related_prs: []
approvals:
  required: ["Owner"]
  status: pending
...
| `docs/delivery/epics/s12/` | Day1 intake + Day2 vision continuity для GitHub API rate-limit resilience; Day1 фиксирует controlled wait-state, owner/operator transparency, split `platform PAT` vs `agent bot-token` и handover issue `#413`, а следующие day-эпики создаются последовательно после owner review | `docs/delivery/epics/s12/epic_s12.md` |
