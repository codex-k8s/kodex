...
| `docs/delivery/epics/s9/` | Day1 intake + Day2 vision + Day3 PRD package (`epic + prd`) для Mission Control Dashboard и каталог Sprint S9 (control-plane UX, active-set dashboard, discussion-first flow, realtime/provider reconciliation) | `docs/delivery/epics/s9/epic_s9.md` |
