...
| `docs/delivery/epics/s11/` | Day1 intake + Day2 vision + Day3 PRD package (`epic + prd`) для Telegram-адаптера как первого внешнего channel path; continuity issue `#444` 2026-03-14 закрыта как `state:superseded` historical handover, PRD stage выполнен в `#448`, а issue `#452` создана для `run:arch` | `docs/delivery/epics/s11/epic_s11.md` |
