...
| NFR-014 | Воспроизводимый OpenAPI codegen в CI | `docs/product/requirements_machine_driven.md`, `docs/architecture/api_contract.md`, `docs/delivery/epics/s2/epic-s2-day1-migrations-and-schema-ownership.md`, `deploy/base/kodex/codegen-check-job.yaml.tpl` | covered |
