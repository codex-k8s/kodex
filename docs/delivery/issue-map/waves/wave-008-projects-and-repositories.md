...
| #633 | `docs/domains/projects-and-repositories/delivery/wave8_project_catalog.md`, `deploy/base/project-catalog/**`, `services/internal/project-catalog/**`, `scripts/**`, `bootstrap/remote/70_finalize_and_report.sh` | projects-and-repositories | закрывается как выполненная | Правила веток, релизная политика, политика размещения, манифесты и закрывающий контрольный срез. |
