...
| #633 | `docs/domains/projects-and-repositories/delivery/wave8_project_catalog.md`, `deploy/base/project-catalog/**`, `services/internal/project-catalog/**`, `scripts/**`, `bootstrap/local/steps/70_finalize_and_report.sh` | projects-and-repositories | закрыта как выполненная | Правила веток, релизная политика, политика размещения, манифесты и закрывающий контрольный срез. |
