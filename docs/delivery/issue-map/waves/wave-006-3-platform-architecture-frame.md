...
| #601 | `docs/platform/architecture/provider_integration_model.md`, `docs/platform/architecture/data_model.md` | Доступ и аккаунты | запланировано | Внешние аккаунты и аккаунты провайдера должны иметь явный контур владения и область действия политики. |
