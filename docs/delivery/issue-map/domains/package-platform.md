...
| не назначено | `services/internal/package-hub/**`, `docs/catalogs/plugins/**`, `docs/catalogs/package-store/**` | PKG-6.3+ | запланировано | Следующие специализированные сценарии магазина, плагинов и пользовательского контента без runtime-запуска и provider-native синхронизации. |
