...
| не назначено | `services/internal/package-hub/**`, `docs/catalogs/plugins/**`, `docs/catalogs/guidance-packages/**` | PKG-6.2+ | запланировано | Следующие специализированные сценарии руководящих пакетов, магазина и пользовательского контента без runtime-запуска и provider-native синхронизации. |
