...
| не назначено | `services/internal/package-hub/**`, `docs/domains/package-platform/architecture/data_model.md` | PKG-3.2/PKG-3.4 | запланировано | БД, миграции, outbox и базовые чтения. |
