...
| не назначено | `services/internal/package-hub/**`, `docs/domains/package-platform/architecture/data_model.md` | PKG-3.3/PKG-3.4 | запланировано | Установки, схемы секретов, проверки, outbox и базовые чтения. |
