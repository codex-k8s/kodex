...
| не назначено | `services/internal/package-hub/**`, `docs/domains/package-platform/architecture/data_model.md` | PKG-3.4 | запланировано | Outbox и базовые repository-backed gRPC чтения. |
