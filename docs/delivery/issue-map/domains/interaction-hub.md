...
| не назначено | `docs/domains/interaction-hub/delivery/interaction_hub_delivery.md` | IH-4+ | planned | Следующие срезы должны выделяться в отдельные Issue: request lifecycle, delivery, channel contract integration, MCP и ops. |
