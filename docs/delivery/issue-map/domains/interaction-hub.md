...
| не назначено | `docs/domains/interaction-hub/delivery/interaction_hub_delivery.md` | IH-5b+ | planned | Следующие срезы должны выделяться в отдельные Issue: delivery attempts, channel contract integration, callback, MCP и ops. |
