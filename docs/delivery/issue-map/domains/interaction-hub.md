...
| не назначено | `docs/domains/interaction-hub/delivery/interaction_hub_delivery.md` | IH-3+ | planned | Следующие срезы должны выделяться в отдельные Issue: модель хранения, lifecycle, delivery, channel contract integration, MCP и ops. |
