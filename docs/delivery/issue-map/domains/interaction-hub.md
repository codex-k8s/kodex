...
| не назначено | `docs/domains/interaction-hub/delivery/interaction_hub_delivery.md` | IH-7+ | planned | Следующие срезы должны выделяться в отдельные Issue: MCP, integration-gateway callback route, concrete channel packages, runtime worker и ops. |
