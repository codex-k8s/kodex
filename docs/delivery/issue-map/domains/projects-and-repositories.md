...
| #281, #282 | `docs/platform/architecture/repository_onboarding.md`, `docs/domains/projects-and-repositories/**`, `docs/delivery/issue-map/domains/provider-native-work-items.md` | wave 8 + wave 10 | требуют выбора владельца | Проектный каталог и основание проектной политики готовы. Перед реализацией bootstrap/adoption нужно выбрать модель `services.yaml`, внешней документации и пакетов; предварительно рекомендован гибридный вариант C. |
