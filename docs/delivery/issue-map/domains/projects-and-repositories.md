...
| #633 | `docs/domains/projects-and-repositories/delivery/wave8_project_catalog.md`, `deploy/base/project-catalog/**`, `scripts/**`, `bootstrap/remote/70_finalize_and_report.sh` | wave 8 | закрывается как выполненная | Правила веток, релизная политика, политика размещения, манифесты, проверочный путь и закрытие Wave 8. |
