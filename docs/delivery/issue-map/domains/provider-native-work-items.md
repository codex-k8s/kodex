...
| не назначено | `services/internal/provider-hub/**`, `docs/domains/provider-native-work-items/delivery/provider_hub_delivery.md` | PRV-7b | planned | Общий конвейер команд операций записи без реальных GitHub/GitLab операций записи. |
