...
| #322 | `docs/domains/agent-orchestration/README.md`, `docs/domains/agent-orchestration/product/requirements.md`, `docs/domains/agent-orchestration/architecture/design.md`, `docs/domains/agent-orchestration/architecture/data_model.md`, `docs/domains/agent-orchestration/architecture/api_contract.md`, `docs/domains/agent-orchestration/delivery/agent_manager_delivery.md`, `docs/platform/architecture/codex_hooks_and_skills.md` | GOV-0 | active | Синхронизация границы Human gate: `agent-manager` хранит ожидание flow и ссылки, а gate request/decision владеет `governance-manager`; delivery остаётся у `interaction-hub`. |
