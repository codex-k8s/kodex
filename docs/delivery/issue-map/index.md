---
doc_id: IDX-CK8S-ISSUE-MAP-0001
type: issue-map-index
title: kodex — индекс карты Issue
status: active
owner_role: KM
...
| Домен | Файл |
|---|---|
| Доступ и аккаунты | `domains/access-and-accounts.md` |
| Проекты и репозитории | `domains/projects-and-repositories.md` |
