...
| `access-manager` | `fleet-manager` | FLEET-0..FLEET-1 не блокируются; кодовые срезы требуют проверки прав на scope, серверы, кластеры и placement rules. | Ключи действий заведены в FLEET-1; подключить проверки доступа в FLEET-3. |
