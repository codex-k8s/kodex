...
После PKG-6.1 следующий независимый срез — PKG-6.2 по руководящим пакетам. PKG-5.3b остаётся заблокированным до появления access-контракта заполненности секретов установки.
