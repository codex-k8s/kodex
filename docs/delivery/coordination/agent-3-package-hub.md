...
После PKG-6.2 следующий независимый срез нужно выбирать между специализированными сценариями магазина и эксплуатационным контуром. PKG-5.3b остаётся заблокированным до появления access-контракта заполненности секретов установки.
