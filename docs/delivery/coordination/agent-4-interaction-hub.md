...
Следующий рациональный срез — IH-2: сервисный каркас `interaction-hub` поверх утверждённых контрактов. Конкретные внешние каналы, callback routes `integration-gateway` и runtime-нагрузки пакетов не смешивать с IH-2.
