...
related_issues: [325, 327, 333, 335, 337, 340, 351]
related_prs: []
approvals:
  required: ["Owner"]
  status: pending
...
| `docs/delivery/traceability/s9_mission_control_dashboard_history.md` | Sprint S9 | История intake/vision/prd/arch решений по Mission Control Dashboard и continuity issue `#351` для design stage |
