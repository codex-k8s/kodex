...
related_issues: [325, 327, 333, 335, 337, 340, 351, 360, 361, 363, 366, 369, 370, 371, 372, 373, 374, 375, 378, 383, 385, 387, 413, 416, 418, 444, 447, 448, 452]
related_prs: []
approvals:
  required: ["Owner"]
  status: pending
...
| `docs/delivery/traceability/s11_telegram_user_interaction_adapter_history.md` | Sprint S11 | История intake, vision и PRD baseline по Telegram-адаптеру как первому внешнему channel path, включая closed superseded handover issue `#444`, active PRD stage `#448` и continuity issue `#452` для `run:arch` |
