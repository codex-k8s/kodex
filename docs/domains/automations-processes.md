...
- Верхнеуровневый координатор создает отдельный тред каждой волны в назначенной рабочей комнате. Координатор волны запускает рабочих и проверяющих агентов внутри этого треда; один тред является одной наблюдаемой волной.
