...
| `PreCompact` | `agent-manager`, `runtime-manager` | Зафиксировать метаданные checkpoint перед сжатием контекста. |
| `PostCompact` | `agent-manager`, `runtime-manager` | Зафиксировать метаданные checkpoint после сжатия. |
