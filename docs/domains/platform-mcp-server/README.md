...
`platform-mcp-server` описывает платформенную MCP-поверхность для быстрого `agent-manager`, агентов в слотах и будущих управляемых интеграций, а также входной контур hook-событий от hook emitter или локального sidecar.
...
- Нормализация вызовов инструментов и hook-событий.
