...
- базовый GitHub-адаптер, который получает `/rate_limit`, классифицирует состояние аккаунта и возвращает нормализованные снимки лимитов без сохранения секрета.
