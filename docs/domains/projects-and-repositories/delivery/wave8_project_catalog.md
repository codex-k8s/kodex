...
| `ListServiceDescriptors` | Готов в proto. | PostgreSQL-слой готов; gRPC отложена до #631/#632. |
...
| `GetWorkspacePolicy` | Готов в proto. | PostgreSQL-слой готов; gRPC отложена до #631/#632. |
