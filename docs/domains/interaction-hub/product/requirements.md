...
| INT-FR-8 | Домен должен принимать callback внешних каналов через проверенный пограничный контур и связывать callback с исходным запросом и delivery attempt. | Обязательно |
