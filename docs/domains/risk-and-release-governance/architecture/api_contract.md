...
Этот документ является обзором целевого API. После создания proto/AsyncAPI машинные спецификации станут источником правды транспорта, а документ должен обновляться в том же PR при расхождении.
