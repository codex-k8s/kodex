...
- Если доменный API-контракт уже согласован, стабильный OpenAPI `v1` покрывает все согласованные HTTP-сценарии сервиса: команды, чтения, модель ошибок и пользовательские/администраторские/операторские пути.
