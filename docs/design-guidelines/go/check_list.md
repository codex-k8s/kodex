...
- Типы событий, типы агрегатов, scope/action ключи и другие доменные идентификаторы не передаются строковыми литералами там, где нужен повторно используемый контракт.
