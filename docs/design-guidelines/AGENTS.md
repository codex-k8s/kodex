...
- `github.com/codex-k8s/kodex-guidelines-common-ru` — необязательный submodule `docs/sources/guidelines/common`;
- `github.com/codex-k8s/kodex-guidelines-go-ru` — необязательный submodule `docs/sources/guidelines/go`;
- `github.com/codex-k8s/kodex-guidelines-vue-ru` — необязательный submodule `docs/sources/guidelines/vue`.
