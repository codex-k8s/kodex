...
type ProjectCatalogServiceClient interface {
	...
	GetSelfDeployDeployPlan(ctx context.Context, in *GetSelfDeployDeployPlanRequest, opts ...grpc.CallOption) (*SelfDeployDeployPlanResponse, error)
...
func (c *projectCatalogServiceClient) CreateRepositoryBootstrapPullRequest(ctx context.Context, in *CreateRepositoryBootstrapPullRequestRequest, opts ...grpc.CallOption) (*RepositoryBootstrapPullRequestResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RepositoryBootstrapPullRequestResponse)
	err := c.cc.Invoke(ctx, ProjectCatalogService_CreateRepositoryBootstrapPullRequest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *projectCatalogServiceClient) ReconcileAdoptionMergeSignal(ctx context.Context, in *ReconcileAdoptionMergeSignalRequest, opts ...grpc.CallOption) (*BootstrapServicesPolicyImportResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BootstrapServicesPolicyImportResponse)
...
func (c *projectCatalogServiceClient) GetSelfDeployDeployPlan(ctx context.Context, in *GetSelfDeployDeployPlanRequest, opts ...grpc.CallOption) (*SelfDeployDeployPlanResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SelfDeployDeployPlanResponse)
	err := c.cc.Invoke(ctx, ProjectCatalogService_GetSelfDeployDeployPlan_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProjectCatalogServiceServer interface {
	...
	// GetSelfDeployDeployPlan возвращает проверенный project-side deploy input после успешных build jobs.
	GetSelfDeployDeployPlan(context.Context, *GetSelfDeployDeployPlanRequest) (*SelfDeployDeployPlanResponse, error)
	// GetServicesPolicy returns a checked services.yaml projection.
...
func (UnimplementedProjectCatalogServiceServer) GetSelfDeployDeployPlan(context.Context, *GetSelfDeployDeployPlanRequest) (*SelfDeployDeployPlanResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSelfDeployDeployPlan not implemented")
}
...
func _ProjectCatalogService_CreateRepositoryBootstrapPullRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateRepositoryBootstrapPullRequestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProjectCatalogServiceServer).CreateRepositoryBootstrapPullRequest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProjectCatalogService_CreateRepositoryBootstrapPullRequest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProjectCatalogServiceServer).CreateRepositoryBootstrapPullRequest(ctx, req.(*CreateRepositoryBootstrapPullRequestRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ProjectCatalogService_ReconcileAdoptionMergeSignal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReconcileAdoptionMergeSignalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProjectCatalogServiceServer).ReconcileAdoptionMergeSignal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProjectCatalogService_ReconcileAdoptionMergeSignal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProjectCatalogService_GetSelfDeployDeployPlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSelfDeployDeployPlanRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProjectCatalogServiceServer).GetSelfDeployDeployPlan(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProjectCatalogService_GetSelfDeployDeployPlan_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProjectCatalogServiceServer).GetSelfDeployDeployPlan(ctx, req.(*GetSelfDeployDeployPlanRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProjectCatalogService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProjectCatalogService_CreateRepositoryBootstrapPullRequest_Handler,
		},
		{
		...
		{
			MethodName: "GetSelfDeployDeployPlan",
			Handler:    _ProjectCatalogService_GetSelfDeployDeployPlan_Handler,
		},
		{
