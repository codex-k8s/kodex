...
keys=(
  ...
  KODEX_SERVER_PUBLIC_IP KODEX_SERVER_PUBLIC_IPV6_ADDRESS KODEX_PUBLIC_IPV4_CIDR
  KODEX_CONTROL_HOST KODEX_PUBLIC_TLS_MODE
  KODEX_PUBLIC_TLS_ALLOWED_IPV4_ADDRESSES
  KODEX_PUBLIC_TLS_ALLOWED_IPV6_ADDRESSES
  KODEX_PUBLIC_TLS_DNS_TIMEOUT_SECONDS KODEX_PUBLIC_TLS_HTTP_TIMEOUT_SECONDS
  ...
  KODEX_SENTRY_DSN KODEX_DISABLE_OBSERVABILITY
