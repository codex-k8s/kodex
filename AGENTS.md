---
id: AGENT-DOC-001
title: Инструкции для агентов Kodex
type: agent-rules
status: approved
owner: manager
version: 2.2.0
...
функциональные и архитектурные границы Kodex. История удалённой
...
кластеру Kodex или внешнему staging выдаётся только через project runtime
