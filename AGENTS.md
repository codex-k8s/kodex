...
- До первого staging-развертывания допустим облегченный профиль проверок,
  утвержденный владельцем. Перед production-релизом обязательны
  поддерживаемые lint, contract, build, unit, integration, security и use case
  проверки.
