...
func ControlAPIGatewayOperations() map[string]string {
	return map[string]string{
		...
		"platform.query.provider-accounts.blockers.list":                controlplanev1.PlatformQueryService_ListProviderAccountBlockers_FullMethodName,
...
func RuntimeOperations() map[string]string {
	return map[string]string{
		...
		"platform.runtime.assistant.resources.search":         controlplanev1.RuntimeWorkService_SearchAssistantResources_FullMethodName,
