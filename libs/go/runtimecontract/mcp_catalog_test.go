...
func TestRuntimeMCPFilesRequireExactExecutionCatalog(t *testing.T) {
	input := RunnerInput{Mode: RunnerModeTurn, ProjectRef: "prj_fixture", LeaseRef: "lea_fixture", LeaseFence: "fence", LeaseGeneration: 1, FileCatalog: &RuntimeFileCatalog{Ref: "vfc_fixture", Digest: strings.Repeat("a", 64), Purposes: []string{FilePurposeProject}}}
