...
func SystemActions() []ActionDescriptor {
	actions := make([]ActionDescriptor, 0, len(ProjectCatalogActions())+len(PackageHubActions())+len(ProviderHubActions())+len(RuntimeManagerActions())+len(FleetManagerActions())+len(AgentManagerActions())+len(GovernanceManagerActions()))
