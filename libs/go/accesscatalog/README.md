...
Пакет хранит только системные действия, принадлежащие коду платформы, например `project-catalog`, `package-hub`, `provider-hub`, `runtime-manager`, `fleet-manager`, `agent-manager` и `governance-manager`.
