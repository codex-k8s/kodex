      ...
      containers:
        - name: agent-manager
          ...
          env:
            ...
            - name: KODEX_AGENT_MANAGER_SELF_DEPLOY_GOVERNANCE_GATE_ENABLED
              value: "{{ envOr "KODEX_AGENT_MANAGER_SELF_DEPLOY_GOVERNANCE_GATE_ENABLED" "true" }}"
            - name: KODEX_AGENT_MANAGER_SELF_DEPLOY_BUILD_DISPATCH_ENABLED
              value: "{{ envOr "KODEX_AGENT_MANAGER_SELF_DEPLOY_BUILD_DISPATCH_ENABLED" "false" }}"
            - name: KODEX_AGENT_MANAGER_GOVERNANCE_MANAGER_GRPC_ADDR
              value: "{{ envOr "KODEX_AGENT_MANAGER_GOVERNANCE_MANAGER_GRPC_ADDR" "governance-manager:9090" }}"
            - name: KODEX_AGENT_MANAGER_GOVERNANCE_MANAGER_GRPC_AUTH_TOKEN
              valueFrom:
                secretKeyRef:
                  name: kodex-platform-runtime
                  key: KODEX_AGENT_MANAGER_GOVERNANCE_MANAGER_GRPC_AUTH_TOKEN
            - name: KODEX_AGENT_MANAGER_GOVERNANCE_MANAGER_REQUEST_TIMEOUT
              value: "{{ envOr "KODEX_AGENT_MANAGER_GOVERNANCE_MANAGER_REQUEST_TIMEOUT" "10s" }}"
            - name: KODEX_AGENT_MANAGER_EVENT_LOG_DATABASE_DSN
              valueFrom:
                secretKeyRef:
                  name: kodex-platform-runtime
