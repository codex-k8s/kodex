      ...
      containers:
        - name: project-catalog
          ...
          env:
            ...
            - name: KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_ENABLED
              value: "{{ envOr "KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_ENABLED" "true" }}"
            - name: KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_NAME
              value: "{{ envOr "KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_NAME" "project-catalog.provider-adoption-merge" }}"
            - name: KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_LEASE_OWNER
              value: "{{ envOr "KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_LEASE_OWNER" "" }}"
            - name: KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_BATCH_SIZE
              value: "{{ envOr "KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_BATCH_SIZE" "50" }}"
            - name: KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_POLL_INTERVAL
              value: "{{ envOr "KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_POLL_INTERVAL" "1s" }}"
            - name: KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_LEASE_TTL
              value: "{{ envOr "KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_LEASE_TTL" "30s" }}"
            - name: KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_HANDLER_TIMEOUT
              value: "{{ envOr "KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_HANDLER_TIMEOUT" "10s" }}"
            - name: KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_RETRY_INITIAL_DELAY
              value: "{{ envOr "KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_RETRY_INITIAL_DELAY" "1s" }}"
            - name: KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_RETRY_MAX_DELAY
              value: "{{ envOr "KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_RETRY_MAX_DELAY" "1m" }}"
            - name: KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_FAILURE_MESSAGE_LIMIT
              value: "{{ envOr "KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_FAILURE_MESSAGE_LIMIT" "512" }}"
            - name: KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_CONCURRENCY_LIMIT
              value: "{{ envOr "KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_CONCURRENCY_LIMIT" "2" }}"
            - name: KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_MAX_ATTEMPTS
              value: "{{ envOr "KODEX_PROJECT_CATALOG_PROVIDER_ADOPTION_MERGE_CONSUMER_MAX_ATTEMPTS" "5" }}"
          readinessProbe:
            httpGet:
              path: /health/readyz
              port: http
